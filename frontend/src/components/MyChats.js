  ...
  return (
    <div className="my-chats-container">
      <div className="header">
        <p className="community">Join Announcement Sections...</p>

        {/* ✅ Join KrishiBazaar */}
        <button
          onClick={() => handleJoinCommunity("681c43deb269597d6467490d")}
          disabled={
            loading || joinedCommunities.includes("681c43deb269597d6467490d")
          }
          className="join-community-btn"
        >
          {loading
            ? "Joining..."
            : joinedCommunities.includes("681c43deb269597d6467490d")
            ? "Joined ✅"
            : "Join for Recruitments"}
        </button>

        {/* ✅ Join BeemaKisan */}
        <button
          onClick={() => handleJoinCommunity("681c4345b269597d6467490c")}
          disabled={
            loading || joinedCommunities.includes("681c4345b269597d6467490c")
          }
          className="join-community-btn"
        >
          {loading
            ? "Joining..."
            : joinedCommunities.includes("681c4345b269597d6467490c")
            ? "Joined ✅"
            : "Join for Events"}
        </button>
